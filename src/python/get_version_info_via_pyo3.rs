...
impl<'py> From<super::get_version_info_from_pyo3_py_token::Error<'py>> for Error {
    fn from(err: super::get_version_info_from_pyo3_py_token::Error<'py>) -> Self {
        match err {
            ...
            super::get_version_info_from_pyo3_py_token::Error::VersionInfoReturnedNotATuple(
                _err,
            ) => Self::VersionInfoReturnedNotATuple,
        }
    }
}
...
pub fn get_version_info_via_pyo3() -> Result<PythonVersionInfo, Error> {
    Python::with_gil(|py| {
        super::get_version_info_from_pyo3_py_token::get_version_info_from_pyo3_py_token(&py)
            .map_err(Error::from)
    })
}
